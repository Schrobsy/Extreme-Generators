package de.schrobsy.extremegenerators.screen;
...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, ExtremeGenerators.MOD_ID);

    public static final DeferredHolder<MenuType<?>, MenuType<BioGeneratorMenu>> BIO_GENERATOR_MENU =
            registerMenuType("bio_generator_menu", BioGeneratorMenu::new);
