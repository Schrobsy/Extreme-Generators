package de.schrobsy.extremegenerators.screen.custom;
...
public class BioGeneratorMenu extends AbstractContainerMenu {
    ...
    public BioGeneratorMenu(int pContainerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.BIO_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv, 1);
        this.blockEntity = ((BioGeneratorBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.BIO_GENERATOR.get());
    }
